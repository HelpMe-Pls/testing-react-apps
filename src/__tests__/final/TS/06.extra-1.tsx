...
test('displays the users current location', async () => {
	...
	>
	// explained at 3:15 from https://epicreact.dev/modules/testing-react-apps/mocking-browser-apis-and-modules-extra-credit-solution-1
	function useMockCurrentPosition() {
		const state = React.useState<CurrentPositionReturn>([
			undefined, // position
			undefined, // error
		])
