...
## What I've learnt
- Use `expect(submittedData).toEqual()` to assert the `submittedData` is the same as the input values. 
- Use [`jest.fn()`](https://github.com/HelpMe-Pls/testing-react-apps/blob/master/src/__tests__/final/TS/04.tsx) as a mock function (at line `18`) and assert it was called correctly rather than defining your own.
- [Abstracting the assertion](https://github.com/HelpMe-Pls/testing-react-apps/blob/master/src/__tests__/final/TS/04.extra-3.tsx) of end user's input with `faker` (at line `15 - 16`).
- [Overriding](https://epicreact.dev/modules/testing-react-apps/form-testing-extra-credit-solution-3) data assertion for a [specific](https://github.com/HelpMe-Pls/testing-react-apps/blob/master/src/__tests__/final/TS/04.extra-3.tsx) test case.
- [Generating](https://github.com/HelpMe-Pls/testing-react-apps/blob/master/src/__tests__/final/TS/04.tsx) test data by using [`@jackfranklin/test-data-bot`](https://www.npmjs.com/package/@jackfranklin/test-data-bot) (it also handles overriding data assertion).
## Background
