...
## What I've learnt
- Use the [`wrapper` option](https://github.com/HelpMe-Pls/testing-react-apps/blob/master/src/__tests__/final/TS/07.tsx) of the `render()` from `testing-library/react` to test a component that uses context.
- Avoid implementation details by SoC into [another module](https://github.com/HelpMe-Pls/testing-react-apps/blob/master/src/test/test-utils.tsx).
## Background
