...
# What I've learnt
- Use `@testing-library/react` instead of `Jest`
- [Config](https://epicreact.dev/modules/testing-react-apps/simple-test-with-react-testing-library-extra-credit-solution-1) `@testing-library/jest-dom` (at 1:10) to display better error messages.
