...
- Assert [the order](https://github.com/HelpMe-Pls/testing-react-apps/blob/master/src/__tests__/final/TS/01.tsx) of your elements by using Array destructuring
- Remember to type check DOM element in your test
- Use `dispatchEvent()` method [to fire an event](https://github.com/HelpMe-Pls/testing-react-apps/blob/master/src/__tests__/final/TS/01.extra-1.tsx) that doesn't have a dedicated method (like mouseover)
